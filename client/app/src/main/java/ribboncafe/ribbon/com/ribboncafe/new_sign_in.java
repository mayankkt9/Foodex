...
public class new_sign_in extends AppCompatActivity {
...
//                }
                ...
                auth.signInWithEmailAndPassword(e,p).addOnCompleteListener(new_sign_in.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        progressBar.dismiss();
                        if(task.isSuccessful())
                        {
                            Toast.makeText(new_sign_in.this,"Successfully Signed In", Toast.LENGTH_SHORT).show();
                            Common.currentUser=e;
                            Intent change_activity=new Intent(new_sign_in.this,nav_drawer.class);
                            new_sign_in.this.startActivity(change_activity);
                        }
                        else
                        {
                            Toast.makeText(new_sign_in.this,"Signin Error", Toast.LENGTH_LONG).show();
                        }
